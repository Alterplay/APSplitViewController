...
@interface APBaseSplitViewController()
//- (void) layoutSubviews;
@end

@implementation APBaseSplitViewController
...
- (void) layoutSubviews
{
	...
	_detail.view.frame = CGRectMake(constDetailStartPoint,
                                    ...
                                    size.height + koefficient);
	_devider.frame = CGRectMake(constMasterWidth, 0, constDividerWidth, size.height);
}
...
//	controller.view.backgroundColor = [UIColor redColor];
	...
	[self.view bringSubviewToFront:_devider];
}
...
- (void) loadView
{
	...
	_devider.frame = CGRectMake(constMasterWidth, 0, constDividerWidth, size.height);
	_devider.backgroundColor = [UIColor redColor];
	_devider.autoresizingMask = UIViewAutoresizingFlexibleHeight | UIViewAutoresizingFlexibleRightMargin;
    [self.view addSubview:_devider];
